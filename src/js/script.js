...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (currentPath === "/") {
    fetch("https://test0123481.ru/api/user/profile/?lang=ru",
        {headers: {Authorization: initData}, method: 'GET'}
      )
