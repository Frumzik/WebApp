...
function openModal(event) {
  ...
  let description = event.currentTarget.getElementsByClassName('seriesDescription')[0].innerHTML;
  ...
  document.getElementById('modal').dataset.series_id = event.currentTarget.dataset.id;
